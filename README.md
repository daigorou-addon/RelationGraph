...
1. [Releases](../../releases) から最新の `RelationGraph Setup x.x.x.exe` をダウンロード
2. インストーラーを実行
...
1. Download the latest `RelationGraph Setup x.x.x.exe` from [Releases](../../releases)
2. Run the installer
...
- Family tree app (FamilyTree) coming soon as a separate release
